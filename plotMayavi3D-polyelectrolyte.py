...
def drawMayavi(X, Y, Z, R, count=0):
    ...
    if count==3:
        mlab.points3d(a, b, c, r, colormap="Set1", scale_factor=1)
    if count==4:
        mlab.points3d(a, b, c, r, colormap="Set2", scale_factor=1)
    if count==5:
        mlab.points3d(a, b, c, r, colormap="Set3", scale_factor=1)
    if count==6:
        mlab.points3d(a, b, c, r, colormap="Hot", scale_factor=1)
    if count==7:
        mlab.points3d(a, b, c, r, colormap="Oranges", scale_factor=1)
    if count==8:
        mlab.points3d(a, b, c, r, colormap="jet", scale_factor=1)
    if count==9:
        mlab.points3d(a, b, c, r, colormap="Oranges", scale_factor=1)
    if count==10:
        mlab.points3d(a, b, c, r, colormap="Gray", scale_factor=1)
    if count==11:
        mlab.points3d(a, b, c, r, colormap="hsv", scale_factor=1)
    if count>11:
        mlab.points3d(a, b, c, r, colormap="Prism", scale_factor=1)
