...
for filename in sys.argv[1:]:
    ...
    if first == 0:
        ...
        if len(List)==length:
            ...
            # any excess column of a file compared to the number of columns of the first file will be discarded
            l = (array(List).transpose()[0:No_columns]).transpose() 
